...
abstract class BaseParametro extends AweActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('ID, DESCRIPCION, VALOR, VALOR_MIN, VALOR_MAX, ESTADO, TIPO_CALCULO', 'safe', 'on'=>'searchPagoUnico'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
                ...
                'VALOR_MIN' => Yii::t('app', 'Desde (m³)'),
                'VALOR_MAX' => Yii::t('app', 'Hasta (m³)'),
    ...
    public function search() {
     ...
     public function searchComunidad() {
      ...
      public function searchAlcantarillado() {
        $criteria = new CDbCriteria;
       ...
       // $criteria->compare('DESCRIPCION', 'CONSUMO DE AGUA POTABLE', true);
        ...
        $criteria->compare('VALOR_MIN', $this->VALOR_MIN, true);
        $criteria->compare('VALOR_MAX', $this->VALOR_MAX, true);
        $criteria->compare('ESTADO', 11); // Rubro: alcantarillado
        ...
        return new CActiveDataProvider($this, array(
         ...
         public function searchPagoUnico() {
        $criteria = new CDbCriteria;
       ...
       // $criteria->compare('DESCRIPCION', 'CONSUMO DE AGUA POTABLE', true);
        ...
        $criteria->compare('VALOR_MIN', $this->VALOR_MIN, true);
        $criteria->compare('VALOR_MAX', $this->VALOR_MAX, true);
        $criteria->compare('ESTADO', 7); // Rubro: Pago Unico, al ingresar el usuario
       ...
       // $criteria->compare('DESCRIPCION', 'CONSUMO DE AGUA POTABLE', true);
        ...
        $criteria->compare('VALOR_MIN', $this->VALOR_MIN, true);
        $criteria->compare('VALOR_MAX', $this->VALOR_MAX, true);
        $criteria->compare('ESTADO', 8); // Rubro: Porcentaje de mora
       ...
       // $criteria->compare('DESCRIPCION', 'CONSUMO DE AGUA POTABLE', true);
        ...
        $criteria->compare('VALOR_MIN', $this->VALOR_MIN, true);
        $criteria->compare('VALOR_MAX', $this->VALOR_MAX, true);
        $criteria->compare('ESTADO', 9); // Valor base por mantenimiento
