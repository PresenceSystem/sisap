...
abstract class BaseFactura extends AweActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('CONSUMO_ANTERIOR, CONSUMO_ACTUAL, CONSUMO_CALCULADO, MES_COBRO, ANIO_COBRO, ESTADO, TIPO, NUMERO_FACTURA', 'numerical', 'integerOnly'=>true),
            ...
            array('ID, ID_MEDIDOR_SOCIO, CONSUMO_ANTERIOR, CONSUMO_ACTUAL, CONSUMO_CALCULADO, MES_COBRO, ANIO_COBRO, ESTADO, TIPO, NUMERO_FACTURA', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
                'ID' => Yii::t('app', 'Emisión N°'),
                'ID_MEDIDOR_SOCIO' => Yii::t('app', 'Código de Socio Medidor'),
                ...
                'TIPO' => Yii::t('app', 'Tipo'),
            'NUMERO_FACTURA' => Yii::t('app', 'Factura física N°'),            
                'detalles' => null,
                'iDMEDIDORSOCIO' => null,
        );
    }
