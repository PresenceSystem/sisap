...
//             }
    ...
    public function validatePassword($password) {
        Yii::app()->getSession()->add('tipo_usuario', $this->rol->Rol); //Aumentado para asignar el tipo al usuario session
        Yii::app()->getSession()->add('id_usuario', $this->id); //pk del usuario
