 ...
 * @property integer $FACTURA_COBRA
 *
...
abstract class BaseDetalle extends AweActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array(' PORC_MORA, ESTADO, COD_USUARIO, FACTURA_COBRA', 'numerical', 'integerOnly'=>true),
            array('ID_FACTURA, ID_RUBRO', 'length', 'max'=>11),
            array('V_UNITARIO, V_TOTAL, IVA, VALOR_MORA', 'length', 'max'=>10),
            array('FECHA, FECHA_COBRO', 'safe'),
            array('CANTIDAD, V_UNITARIO, V_TOTAL, IVA, PORC_MORA, VALOR_MORA, FECHA, FECHA_COBRO, COD_USUARIO, FACTURA_COBRA', 'default', 'setOnEmpty' => true, 'value' => null),
            array('ID, ID_FACTURA, ID_RUBRO, CANTIDAD, V_UNITARIO, V_TOTAL, IVA, PORC_MORA, VALOR_MORA, FECHA, FECHA_COBRO, ESTADO, COD_USUARIO, FACTURA_COBRA, FECHA_ACTUALIZACION', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
				...
				'FACTURA_COBRA' => Yii::t('app', 'Cobro vinculado a la factura Nº '),
    ...
    public function search() {
		...
		$criteria->compare('FACTURA_COBRA', $this->FACTURA_COBRA);
