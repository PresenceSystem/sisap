...
/** @var SubcuentaContable $data */
?>
<div class="view">
                    
        <?php if (!empty($data->iDCUENTA->CODIGO)): ?>
        <div class="field">
            <div class="field_name">
                <b><?php echo CHtml::encode($data->getAttributeLabel('ID_CUENTA')); ?>:</b>
            </div>
            <div class="field_value">
                <?php echo CHtml::encode($data->iDCUENTA->CODIGO); ?>
            </div>
        </div>
        ...
        <?php if (!empty($data->SUBCUENTA)): ?>
        <div class="field">
            <div class="field_name">
                <b><?php echo CHtml::encode($data->getAttributeLabel('SUBCUENTA')); ?>:</b>
            </div>
            <div class="field_value">
                <?php echo CHtml::encode($data->SUBCUENTA); ?>
            </div>
        </div>
