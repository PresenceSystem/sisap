...
$this->menu = array(
    ...
    array('label' => Yii::t('AweCrud.app', 'Editar plantilla'), 'icon' => 'pencil', 'url' => array('tconvocatoria/actualizarConvocatoriaValidacion', 'id' => $model->COD_CONVOCATORIA)),
    array('label' => Yii::t('AweCrud.app', 'Exportar a Word'), 'icon' => 'pencil', 'url' => array('imprimirConvocatoriasValidacion', 'id' => $model->COD_CONVOCATORIA)),
);
?>
<fieldset>
    <div class="form fondoBDanterior">
        ...
        <?php
        echo '<center><div class="badge badge-info">Convocados para la validación de datos: <h4>' . $model->cODJUNTA->SECTOR_NOMBRE.'</div></center>' ;
...
//                       $array_dias = array();
                        ...
                        foreach ($rows as $row) {    
                            ...
                            //$Fecha=strftime("%A, %d de %B del %Y  a las %Hh%M",strtotime($Fecha));  
                             ...
                             $Imprimir_Fecha=strftime("%A, %d de %B del %Y  a las <b> %Hh%M",strtotime($Fecha)); 
				...
				//*****************************//
				//IMPRIMIR CITACIÓN
				echo '<div class="badge badge-success">'.$contador.' - Secretaria: '.$cuenta_secretarias.'</div>';
