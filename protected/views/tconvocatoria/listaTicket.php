...
$this->menu = array(
    ...
    array('label' => Yii::t('AweCrud.app', 'Generador de Tickets'), 'icon' => 'pencil', 'url' => array('tconvocatoria/verTicket', 'id' => $model->COD_CONVOCATORIA)),
    array('label' => Yii::t('AweCrud.app', 'Exportar a Word'), 'icon' => 'pencil', 'url' => array('imprimirTickets', 'id' => $model->COD_CONVOCATORIA)),
);
?>
