...
<fieldset>
    <legend>
        Buscar tickets creados anteriormente    </legend>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
    ...
    'dataProvider' => $model->searchTicket(),
    'filter' => $model,
    'columns' => array(
    //    'COD_CONVOCATORIA',
        //'COD_JUNTA',
...
//        'ENCABEZADO',
        ...
        */
         array(
                ...
                'template' => '{ver} {actualizarTicket} {delete}',
                'buttons' => array
                    (
                    'ver' => array
                        (
                        'label' => 'VER CONFIGURACION DEL TICKET',
                        'icon' => 'list white',
                        'url' => 'Yii::app()->createUrl("tconvocatoria/verTicket", array("id"=>$data->COD_CONVOCATORIA))',
//                        'imageUrl' => Yii::app()->request->baseUrl . '/images/ver.jpeg',
                    ...
                    'actualizarTicket' => array
                        (
                        'label' => 'EDITAR',
                        'icon' => 'edit white',
                        'url' => 'Yii::app()->createUrl("tconvocatoria/actualizarTicket", array("id"=>$data->COD_CONVOCATORIA))',
//                        'imageUrl' => Yii::app()->request->baseUrl . '/images/ver.jpeg',
                        'options' => array(
