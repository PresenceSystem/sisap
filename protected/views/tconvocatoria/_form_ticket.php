...
<?php echo $form->dropDownListRow($model, 'COD_JUNTA', CHtml::listData(Junta::model()->findAll(), 'COD_JUNTA', Junta::representingColumn()), array('prompt' => Yii::t('AweApp', 'None'))) ?>
   <?php /*
    <div class="container">
    ...
    */ ?>
    ...
    <?php // echo $form->dropDownListRow($model, 'TIPO', array('a la REUNIÓN por los pagos' => 'REUNION POR PAGOS', 'a la SESIÓN EXTRAORDINARIA' => 'SESIÓN EXTRAORDINARIA', 'a la SESIÓN' => 'SESIÓN', 'al TRABAJO' => 'TRABAJO', 'a los PAGOS' => 'PAGOS', 'a los COBROS' => 'COBROS', '' => ''), array('class' => 'span5', 'maxlength' => 1)) ?>
    <div class="row">
        <?php
...
//        'htmlOptions' => array('style' => 'width:80px;'),));
    ...
    <?php // echo $form->textAreaRow($model, 'NOTA', array('class' => 'span5', 'maxlength' => 200)) ?>
