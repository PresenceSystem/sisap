...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('clase-contable-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'Manage') ?> <?php echo ClaseContable::label(2) ?>    </legend>
