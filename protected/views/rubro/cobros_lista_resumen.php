 ...
 */
$this->menu=array(
      array('label' =>  'POR ORGANIZACIÓN ', 'icon' => 'plus', 'url' => array('cobros_lista_resumen_organizacion')),
);
?>
 
<h3 class="alert-success text-center"> <?php echo 'COBROS REALIZADOS<BR>' ?>  </h3>  
...
<h3 class="alert-danger text-center"> <?php echo 'PENDIENTES DE COBRO<BR>' ?>  </h3>  
