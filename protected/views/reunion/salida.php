...
<fieldset>
    <legend class="text-center">
        <h3 class="text-info">SELECCIONE LA REUNION PARA REGISTRAR LA SALIDA</h3> </legend>
        <span>
            Busque la reunión de la cual se registrará la salida. 
             <br> <B>Nota:</B> Muestra reuniones que falta registran la salida o fue la reunión cancelada
        </span>
...
//                        'icon' => 'list white',
                        'url' => 'Yii::app()->createUrl("reunion/cambiar_de_entrada_salida/", array("id"=>$data->CODIGO_REUNION))',
