...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->CODIGO_REUNION) => array('view', 'id'=>$model->CODIGO_REUNION),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->CODIGO_REUNION)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Reunion::label(); ?> <?php echo CHtml::encode($model) ?></legend>
