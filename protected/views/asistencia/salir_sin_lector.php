...
<fieldset>
    ...
    if (isset($socio)) {
        ...
        echo '<h3 class="text-inverse badge-info text-center">' . $ultimo_registrado . '</h3>';
    };
    ?>
    <table width="100%">
        <tr>
            <td width="50%">
                ...
                <?php echo $this->renderPartial('_form_salida_sin_lector', array('model' => $model)); ?>
                 <?php
                    $this->widget('bootstrap.widgets.TbButtonGroup', array(
                        ...
                        'buttons' => array(
                            array('label' => 'REGISTRAR CON LECTOR DE CÓDIGO DE BARRA', 'icon' => 'barcode',
                                'url' => array('/asistencia/salir/', 'id' => $model_reunion->CODIGO_REUNION)),
                        ),
                            )
                    ); ?>
            </td>
