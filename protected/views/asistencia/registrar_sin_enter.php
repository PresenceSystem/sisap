    ...
    <legend>
        <legend>
            <h3 class="btn-warning text-center ">
                REGISTRO DE ASISTENCIA POR CÓDIGO DE BARRA SIN ENTER
            </h3>
        </legend>
...
?>
                ...
                <?php /* if (Yii::app()->user->hasFlash('success')): ?>
                    ...
                    <!--</div>-->
                        ...
                        <?php echo $this->renderPartial('_form_sin_enter', array('model' => $model)); ?>
                <center> <img src="<?php echo Yii:: app()->baseUrl . '/images/pagina/codigo_de_barra.jpg' ?>" width="30%"/></center>
