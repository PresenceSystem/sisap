...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->CODIGO_ASISTENCIA) => array('view', 'id'=>$model->CODIGO_ASISTENCIA),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->CODIGO_ASISTENCIA)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Asistencia::label(); ?> <?php echo CHtml::encode($model) ?></legend>
