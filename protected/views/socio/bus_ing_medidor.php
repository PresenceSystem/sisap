...
");
?>
<h3 class="btn-info text-center"> BUSCAR SOCIO DE AGUA POTABLE</h3>
<fieldset>
    <ul>
        <li>
            Busque el socio para ingresar un medidor nuevo.
        </li>
        <li>
            El usuario puede tener mas de un medidor a su nombre.
        </li>
        <li>
