<div class="form">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            <?php echo $form->textFieldRow($model, 'CI', array('labelOptions' => array('label' => 'CI/RUC'), 'class' => 'cedula span-5', 'maxlength' => 13)); ?>
        </div> 
        <br>    
    ...
    <div class="col-md-12">
        <div class="col-md-6">
            ...
            <?php echo $form->textFieldRow($model, 'EMAIL', array('class' => 'span-5', 'maxlength' => 50)) ?>  
             <?php echo $form->dropDownListRow($model, 'COD_GRUPO', CHtml::listData(Grupo::model()->findAll(), 'ID', Grupo::representingColumn() ) ) ?>

             <?php echo $form->checkBoxRow($model,'USU_PARTICIPA_COMUNIDAD',  array('checked'=>'checked')); ?>
             <?php echo $form->checkBoxRow($model,'USU_ALCANTARILLADO'); ?>
