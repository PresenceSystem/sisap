...
echo "<div class='badge badge-success'> <h5>CONSUMO TOTAL DE LA ORGANIZACIÓN: ".$consumo_total." m³</h5></div>";
echo "<div class='badge badge-info'> <h4>LA ORGANIZACIÓN CUENTA CON ".$contador_total_grupos." ACOMETIDAS DE AGUA POTABLE</h4></div>";
