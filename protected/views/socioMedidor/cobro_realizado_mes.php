 ...
 */ 
$this->menu=array(   
    array('label' => Yii::t('AweCrud.app', 'Convertir a excel'), 'icon' => 'pencil', 'url' => array('cobro_realizado_mes_excel')),
		...
		<tr>
            <td colspan="2">
               <h4 class="btn-success text-center ">
                        ...
                        Cobro para la Junta Administradora de Agua Potable y Alcantarillado San Vicente de Lacas
                   </h4>
            </td>
        </tr>
        <tr>        
                        ...
                        <th style="text-align:center;">VALOR RECAUDADO</th>                       
                             ...
                             foreach ($model_socios as $modelo_socio) {
                                 echo "<tr>";                               
                                    ...
                                    echo '<td>'.$modelo_socio->PARTICIPA_COMUNIDAD.'</td>';
