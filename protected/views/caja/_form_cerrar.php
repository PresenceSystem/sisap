<div class="form">
    ...
    <?php echo $form->errorSummary($model) ?>
                            ...
                            <?php //echo $form->textFieldRow($model, 'SALDO_INICIAL', array('class' => 'span5')) ?>
                        ...
                        <?php //echo $form->textFieldRow($model, 'RECUENTO', array('class' => 'span5', 'disabled'=>true,'maxlength' => 8)) ?>
                        <?php echo $form->textFieldRow($model, 'EFECTIVO', array('class' => 'span5', 'disabled'=>false,  'maxlength' => 8)) ?>                    
                        ...
                        <?php echo $form->textAreaRow($model, 'DESCRIPCION', array('class' => 'span5', 'maxlength' => 3000)) ?>
