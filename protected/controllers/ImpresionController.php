...
class ImpresionController extends AweController
{
	/**
...
public function accessRules() {
	...
	public function actionCreate()
	{
        ...
        $this->performAjaxValidation($model, 'impresion-form');

        if(isset($_POST['Impresion']))
		{
			$model->attributes = $_POST['Impresion'];
			if($model->save()) {
                $this->redirect(array('view', 'id' => $model->COD_IMPRESION));
            }
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Impresion');
